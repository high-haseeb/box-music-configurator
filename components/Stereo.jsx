...
export function Stereo({color, showColorMenu, ...props}) {
  const { nodes, materials } = useGLTF('/15_12_2023_Meble.gltf')

  const changeColor = (m, e) => {
    showColorMenu('visible',e.clientX, e.clientY);
  }
  useEffect(() => {
    applyProps(nodes.body.material, {color: color});
    // applyProps(nodes['grill-inner-left'], {color: palettes[Math.floor(Math.random() * palettes.length)][Math.floor(Math.random())]})
    // applyProps(nodes['grill-inner-right'], {color:palettes[Math.floor(Math.random() * palettes.length)][Math.floor(Math.random())]})
  },[color])
 ...
 return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes['b-speaker-r1'].geometry} material={nodes['b-speaker-r1'].material} position={[0.3, 0.692, -0.302]} rotation={[0, 0, -Math.PI / 2]} scale={0.11} />
      <mesh geometry={nodes['b-speaker-r3'].geometry} material={nodes['b-speaker-r3'].material} position={[0.3, 0.692, -0.655]} rotation={[0, 0, Math.PI / 2]} scale={-0.11} />
      <mesh geometry={nodes['b-speaker-r2'].geometry} material={nodes['b-speaker-r2'].material} position={[0.312, 0.314, -0.302]} rotation={[0, 0, Math.PI / 2]} scale={0.11} />
      <mesh geometry={nodes['b-speaker-r4'].geometry} material={nodes['b-speaker-r4'].material} position={[0.312, 0.314, -0.655]} rotation={[0, 0, -Math.PI / 2]} scale={-0.11} />
      <mesh geometry={nodes['b-speaker-l1'].geometry} material={nodes['b-speaker-l1'].material} position={[0.3, 0.692, 0.631]} rotation={[0, 0, -Math.PI / 2]} scale={0.11} />
      <mesh geometry={nodes['b-speaker-l3'].geometry} material={nodes['b-speaker-l3'].material} position={[0.3, 0.692, 0.287]} rotation={[0, 0, Math.PI / 2]} scale={-0.11} />
      <mesh geometry={nodes['b-speaker-l2'].geometry} material={nodes['b-speaker-l2'].material} position={[0.312, 0.314, 0.631]} rotation={[0, 0, Math.PI / 2]} scale={0.11} />
      <mesh geometry={nodes['b-speaker-l4'].geometry} material={nodes['b-speaker-l4'].material} position={[0.312, 0.314, 0.287]} rotation={[0, 0, -Math.PI / 2]} scale={-0.11} />
      <mesh geometry={nodes['grill-inner-right'].geometry} material={nodes['grill-inner-right'].material} position={[0.286, 1.088, -0.588]} rotation={[0, 0, 1.798]} scale={[-0.05, -0.066, -0.113]} />
      <mesh geometry={nodes['grill-inner-left'].geometry} material={nodes['grill-inner-left'].material} position={[0.286, 1.088, 0.601]} rotation={[0, 0, 1.798]} scale={[-0.05, -0.066, -0.113]} />
      <mesh geometry={nodes.body.geometry} material={nodes.body.material} position={[0, 0.729, 0]} scale={[0.31, 0.65, 0.783]} onClick={(e) => changeColor(nodes.body.material, e)}/>
      ...
      <mesh geometry={nodes['big-speaker-grill-right'].geometry} material={nodes['big-speaker-grill-right'].material} position={[0.24, 0.503, -0.48]} rotation={[0, 0, -Math.PI / 2]} scale={[0.277, 0.091, 0.277]} />
      ...
      <mesh geometry={nodes['speaker-right001'].geometry} material={nodes['speaker-right001'].material} position={[-0.005, 1.133, -0.797]} rotation={[Math.PI / 2, 0, 0]} scale={[0.155, 0.056, 0.155]} />
      <mesh geometry={nodes['speaker-left001'].geometry} material={materials['Scratched Silver Metal']} position={[-0.005, 1.133, 0.792]} rotation={[Math.PI / 2, 0, Math.PI]} scale={[0.155, 0.056, 0.155]} />
      <mesh geometry={nodes['small-speeker-inner'].geometry} material={materials.Plastic} position={[0, 0.729, 0]} scale={[0.31, 0.65, 0.783]} />
      <mesh geometry={nodes['small-speeker-inner001'].geometry} material={materials.Plastic} position={[0, 0.729, 0]} scale={[0.31, 0.65, 0.783]} />
      <mesh geometry={nodes.body003.geometry} material={materials.Plastic} position={[0, 0.729, 0]} scale={[0.31, 0.65, 0.783]} />
      <mesh geometry={nodes.body004.geometry} material={materials.Plastic} position={[0, 0.729, 0]} scale={[0.31, 0.65, 0.783]} />
      <mesh geometry={nodes.big_speaker_inner_2.geometry} material={materials.Plastic} position={[0, 0.729, 0]} scale={[0.31, 0.65, 0.783]} />
      <mesh geometry={nodes.big_speaker_inner_1.geometry} material={materials.Plastic} position={[0, 0.729, -0.956]} scale={[0.31, 0.65, 0.783]} />
      <mesh geometry={nodes['big-speaker-grill-right001'].geometry} material={nodes['big-speaker-grill-right001'].material} position={[0.24, 0.503, -0.48]} rotation={[0, 0, -Math.PI / 2]} scale={[0.277, 0.091, 0.277]} />
      <mesh geometry={nodes['big-speaker-grill-right002'].geometry} material={nodes['big-speaker-grill-right002'].material} position={[0.24, 0.503, 0.457]} rotation={[0, 0, -Math.PI / 2]} scale={[0.277, 0.091, 0.277]} />
      <mesh geometry={nodes['big-speaker-grill-right003'].geometry} material={nodes['big-speaker-grill-right003'].material} position={[0.24, 0.503, 0.457]} rotation={[0, 0, -Math.PI / 2]} scale={[0.277, 0.091, 0.277]} />
      <mesh geometry={nodes['top-bannermid'].geometry} material={materials.Plastic} position={[0.017, 2.078, 0.012]} rotation={[0, 1.571, 0]} scale={[0.749, 10.653, 0.023]} />
      <mesh geometry={nodes['top-banner-sides'].geometry} material={materials.Plastic} position={[0.017, 2.078, 0.012]} rotation={[0, 1.571, 0]} scale={[0.749, 10.653, 0.023]} />
    </group>
  )
}

useGLTF.preload('/15_12_2023_Meble.gltf')
